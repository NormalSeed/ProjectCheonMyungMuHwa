...
public class TRareChest : ITable
{
    private Dictionary<int, RareChestData> _chests = new();
    ...
    private IEnumerator LoadFromSheet(string url)
    {
        ...
        if (req.result == UnityWebRequest.Result.Success) {
            ...
            Debug.LogError("RareChestTable load failed: " + req.error);
        }
    }
    ...
    public RareChestData GetData(int stage)
    {
